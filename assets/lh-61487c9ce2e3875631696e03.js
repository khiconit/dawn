...
window.HUB.formatMoney = window.HUB.formatMoney || function(t, r) {
    ...
    return i.replace(a, o)
                        ...
                        ;var cb_CollectionProduct  = function($) {
    ...
    var $this = jQuery(this),
        ...
        $this.find('.lh-quick-shop-btn').on('click', function(){
            ...
            $form.find('.lh-product-form__variants .selector-wrapper:nth-child('+index+')').hide();
					...
					cb_CollectionProduct.bind($('section#LH-U1Z3H5X5C0C [data-com="CollectionProduct"]').get(0))(jQuery);
                    }
                    cb.bind($('section#LH-U1Z3H5X5C0C').get(0))(
                        {
                            url: "https://dev.the4.co/workspace//BASE/product-grid/product-grid/",
                            settings: {"crop_type":"auto","crop_size":"480x","crop_position":"center"}
                        },
                        {"crop_type":"auto","crop_size":"480x","crop_position":"center"},
                        jQuery
                    );
                })(window.jQuery);
                console.log("This page layout has been built by https://www.layouthub.com");    
